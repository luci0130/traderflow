@php
    ...
    $bestId = $record !== null ? $this->bestSupermarketPriceId($record) : null;
...
@if ($bestId !== null)
    <button
        ...
        @class([
            ...
            'border-gray-300 bg-white hover:border-emerald-400 dark:border-white/20 dark:bg-white/5' => ! $isSelected,
        ])
